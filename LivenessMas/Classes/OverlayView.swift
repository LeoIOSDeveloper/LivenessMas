...
class OverlayView: UIView {
    var previousNoseTipY: Float = 0.0
    ...
    private let label: UILabel = {
        ...
        label.numberOfLines = 0 // Use multiple lines if needed
        return label
    }()
    ...
    func updateLabel(text: String) {
        ...
        label.frame.origin = CGPoint(x: 10, y: 10) // Adjust the position as needed
    }
     ...
     */
    func drawLandmarks(_ landmarks: [[NormalizedLandmark]], orientation: UIImage.Orientation, withImageSize imageSize: CGSize, trackingConfidenceThresholdVertical : Float = 0.06) {
